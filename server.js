...
app.use(
    cors({
      credentials: true,
      origin: ["http://localhost:3000", "http://localhost:3003",  "http://localhost:3004", 'http://127.0.0.1:5502', 'http://127.0.0.1:5502', 'https://admininstacart.onrender.com', 'https://instacartcustomers.com', 'https://agentfront.onrender.com'],
    })
  );
